...
#ifndef WIKIPEDIABROWNFIELD_SWIFT_H
#define WIKIPEDIABROWNFIELD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WikipediaBrownfield",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19WikipediaBrownfield25ExpoBrownfieldAppDelegate")
@interface ExpoBrownfieldAppDelegate : UIResponder <UIApplicationDelegate>
...
@class NSCoder;
@class NSBundle;
SWIFT_CLASS("_TtC19WikipediaBrownfield25ReactNativeViewController")
@interface ReactNativeViewController : UIViewController
- (nonnull instancetype)initWithModuleName:(NSString * _Nonnull)moduleName initialProps:(NSDictionary * _Nullable)initialProps launchOptions:(NSDictionary * _Nullable)launchOptions OBJC_DESIGNATED_INITIALIZER;
